...
Goals: 1. To identify events that are harmful to population health
       2. To Identify events that have the greatest economic consequences
...
```r
StormData <- read.csv("C:/Users/b.s.priya/Documents/Data Science_R/Reproducible Research/Proj2/repdata_data_StormData.csv.bz2")
colnames(StormData)
```
...
![](https://github.com/BanuPriyaNaidu91/Reproducible-Research_Proj2/tree/master/plot1.png)<!-- -->
...
![](https://github.com/BanuPriyaNaidu91/Reproducible-Research_Proj2/tree/master/plot2.png)<!-- -->
